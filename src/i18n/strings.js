export const strings = {
  ...
  projectDetail: {
    ...
    whatItIs: { es: 'Qué es', en: 'What it is' },
    theInterestingPart: { es: 'Lo interesante', en: 'The interesting part' },
    caseStudyComingSoon: { es: 'Case study en desarrollo, próximamente.', en: 'Case study coming soon.' },
    viewAllArrow: { es: 'Ver todos', en: 'View all' },
  },
  shared: {
